...
const rndDirectory = path.join(__dirname, "../data/rnd");

if (!fs.existsSync(rndDirectory)) {
  fs.mkdirSync(rndDirectory);
}

router.get("/:rnd", (req, res) => {
  const { rnd } = req.params;
  // console.log(admission);
  const filePath = path.join(rndDirectory, `${rnd}.mdx`);
