const CustomButton = () => {
  return (
    <div className="flex justify-center">
      ...
      >
        <span className=" relative z-[5] inset-0 group-hover:text-transparent group-hover:bg-gradient-to-r from-[#1760a6] to-[#1760a6] group-hover:bg-clip-text group-hover:transition-colors duration-500 ease-out">Apply Now</span>
