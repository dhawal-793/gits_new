...
import Innovation from "./InnovationCarousel"

const LearningWithInnovation = () => {
  return (
    <Container>
      <div className="text-center relative ">
        <h2 className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-extrabold uppercase tracking-wider opacity-50 innovations-text">
          Innovations
