...
function PlacementInfo() {
    return (
      <div className="container  px-4 py-10  sm:rounded-s-full bg-black  bg-cover bg-opacity-80" style={{ backgroundImage: 'url("images/cs.jpg")', backgroundBlendMode: 'multiply' }}>
